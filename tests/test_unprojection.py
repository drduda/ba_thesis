...
class TestQuadric(TestCase):
    ...
    """
    from_ellipse = ConeCamera.construct_by_ellipse(204.024, -102.452, 225.000, -127.567, -177.45, 66.976)
    ...
    """
    double_3d_circle = Double3DCircle.construct_by_ImpEllipse(e_imp, 4, 1)
